...
- use the same value (size and color) for the individual star (starStyle)
  ...
  - use the provided value of size to replace height and width
  - use the provided value of color to replace fill and stroke for full star and stroke only for emptystar
- allow consumer to pass class name as props
  - accept class name prop with default value of empty string
